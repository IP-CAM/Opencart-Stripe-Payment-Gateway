...
function stripeTokenHandler(token) {
    ...
    $.ajax({
        url: 'index.php?route=extension/tmdstripepayment/payment/tmd_stripe_payment|send&stripeToken='+token.id,
        type: 'post',
        dataType: 'json',
        data:'',
        beforeSend: function() {
             ...
             stripe.confirmCardPayment(json['clientSecret']).then(function(result) {
                    if (result.error) {
                        console.error("Payment failed:", result.error.message);
                          ...
                          $.ajax({
                         url: 'index.php?route=extension/tmdstripepayment/payment/tmd_stripe_payment|callback&stripeToken='+token.id,
                        type: 'post',
                        dataType: 'json',
